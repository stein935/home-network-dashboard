export function Terms() {
  return (
    <div className="prose prose-slate mx-auto my-0 max-w-[800px] border-5 border-black bg-white p-6 pb-20 shadow-brutal sm:my-20 md:p-20 md:pb-28">
      ...
      <ul>
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Steineck Home Dashboard.
          </p>
        </li>
        <li>
          <p>
        ...
        <li>
          <p>
            <strong>Website</strong> refers to Steineck Home Dashboard,
            accessible from{' '}
            <a
              href="https://steineck.io"
      ...
      <ul>
        <li>By email: stein935@gmail.com</li>
      </ul>
    </div>
  );
}
